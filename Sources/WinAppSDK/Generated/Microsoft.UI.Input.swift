...
public final class EnteredMoveSizeEventArgs : WinRTClass {
    ...
    public var moveSizeOperation : MoveSizeOperation {
        get { try! _default.get_MoveSizeOperationImpl() }
    }
    ...
    public var pointerScreenPoint : UWP.PointInt32 {
        get { try! _default.get_PointerScreenPointImpl() }
    }
...
public final class EnteringMoveSizeEventArgs : WinRTClass {
    ...
    public var moveSizeWindowId : WinAppSDK.WindowId {
        get { try! _default.get_MoveSizeWindowIdImpl() }
        set { try! _default.put_MoveSizeWindowIdImpl(newValue) }
    }
...
public final class InputNonClientPointerSource : WinRTClass {
    ...
    public lazy var enteredMoveSize : Event<TypedEventHandler<InputNonClientPointerSource?, EnteredMoveSizeEventArgs?>> = {
      .init(
        add: { [weak self] in
          ...
          return try! this.add_EnteredMoveSizeImpl($0)
        },
        remove: { [weak self] in
         try? self?._IInputNonClientPointerSource2.remove_EnteredMoveSizeImpl($0)
       }
      )
    }()
    ...
    public lazy var enteringMoveSize : Event<TypedEventHandler<InputNonClientPointerSource?, EnteringMoveSizeEventArgs?>> = {
      .init(
        add: { [weak self] in
          guard let this = self?._IInputNonClientPointerSource2 else { return .init() }
          return try! this.add_EnteringMoveSizeImpl($0)
        },
        remove: { [weak self] in
         try? self?._IInputNonClientPointerSource2.remove_EnteringMoveSizeImpl($0)
       }
      )
    }()
    ...
    public lazy var exitedMoveSize : Event<TypedEventHandler<InputNonClientPointerSource?, ExitedMoveSizeEventArgs?>> = {
      .init(
        add: { [weak self] in
          guard let this = self?._IInputNonClientPointerSource2 else { return .init() }
          return try! this.add_ExitedMoveSizeImpl($0)
        },
        remove: { [weak self] in
         try? self?._IInputNonClientPointerSource2.remove_ExitedMoveSizeImpl($0)
       }
      )
    }()
    ...
    public lazy var windowRectChanged : Event<TypedEventHandler<InputNonClientPointerSource?, WindowRectChangedEventArgs?>> = {
      .init(
        add: { [weak self] in
          guard let this = self?._IInputNonClientPointerSource2 else { return .init() }
          return try! this.add_WindowRectChangedImpl($0)
        },
        remove: { [weak self] in
         try? self?._IInputNonClientPointerSource2.remove_WindowRectChangedImpl($0)
       }
      )
    }()
    ...
    public lazy var windowRectChanging : Event<TypedEventHandler<InputNonClientPointerSource?, WindowRectChangingEventArgs?>> = {
      .init(
        add: { [weak self] in
          guard let this = self?._IInputNonClientPointerSource2 else { return .init() }
          return try! this.add_WindowRectChangingImpl($0)
        },
        remove: { [weak self] in
         try? self?._IInputNonClientPointerSource2.remove_WindowRectChangingImpl($0)
       }
      )
    }()
...
public final class WindowRectChangedEventArgs : WinRTClass {
    ...
    public var newWindowRect : UWP.RectInt32 {
        get { try! _default.get_NewWindowRectImpl() }
    }
    ...
    public var oldWindowRect : UWP.RectInt32 {
        get { try! _default.get_OldWindowRectImpl() }
    }
...
public final class WindowRectChangingEventArgs : WinRTClass {
    ...
    public var allowRectChange : Bool {
        get { try! _default.get_AllowRectChangeImpl() }
        set { try! _default.put_AllowRectChangeImpl(newValue) }
    }
    ...
    public var newWindowRect : UWP.RectInt32 {
        get { try! _default.get_NewWindowRectImpl() }
        set { try! _default.put_NewWindowRectImpl(newValue) }
    }
    ...
    public var showWindow : Bool {
        get { try! _default.get_ShowWindowImpl() }
        set { try! _default.put_ShowWindowImpl(newValue) }
    }
...
extension WinAppSDK.MoveSizeOperation: @retroactive Hashable, @retroactive Codable {}
