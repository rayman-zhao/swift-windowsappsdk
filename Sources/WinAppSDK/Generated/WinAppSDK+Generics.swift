...
public class IIterableChildSiteLink: WindowsFoundation.IInspectable {
    ...
    open func First() throws -> WindowsFoundation.AnyIIterator<WinAppSDK.ChildSiteLink?>? {
        let (result) = try ComPtrs.initialize { resultAbi in
...
public class IIterableDesktopPopupSiteBridge: WindowsFoundation.IInspectable {
    ...
    open func First() throws -> WindowsFoundation.AnyIIterator<WinAppSDK.DesktopPopupSiteBridge?>? {
        let (result) = try ComPtrs.initialize { resultAbi in
...
internal var __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CChildSiteLinkVTable: __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CChildSiteLinkVtbl = .init(
    ...
    GetMany: {
        guard let __unwrapped__instance = __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CChildSiteLinkWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        var items: [WinAppSDK.ChildSiteLink?] = .from(abiBridge: __IMPL_Microsoft_UI_Content.ChildSiteLinkBridge.self, abi: (count: $1, start: $2))
        let result = __unwrapped__instance.getMany(&items)
        items.fill(abi: $2, abiBridge: __IMPL_Microsoft_UI_Content.ChildSiteLinkBridge.self)
        $3?.initialize(to: result)
        return S_OK
    }
)
...
public class IIteratorChildSiteLink: WindowsFoundation.IInspectable {
    ...
    open func get_Current() throws -> WinAppSDK.ChildSiteLink? {
        let (result) = try ComPtrs.initialize { resultAbi in
    ...
    open func GetMany(_ items: inout [WinAppSDK.ChildSiteLink?]) throws -> UInt32 {
        var result: UINT32 = 0
        try items.toABI(abiBridge: __IMPL_Microsoft_UI_Content.ChildSiteLinkBridge.self) { _items in
            _ = try perform(as: __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CChildSiteLink.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.GetMany(pThis, _items.count, _items.start, &result))
            }
        items = .from(abiBridge: __IMPL_Microsoft_UI_Content.ChildSiteLinkBridge.self, abi: _items)
        }
        return result
    }
...
fileprivate class __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CChildSiteLinkImpl : IIterator, AbiInterfaceImpl {
    ...
    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.collections.iiterator-1.getmany)
    fileprivate func getMany(_ items: inout [WinAppSDK.ChildSiteLink?]) -> UInt32 {
        try! _default.GetMany(&items)
    }
...
internal var __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CDesktopPopupSiteBridgeVTable: __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CDesktopPopupSiteBridgeVtbl = .init(
    ...
    GetMany: {
        guard let __unwrapped__instance = __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CDesktopPopupSiteBridgeWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        var items: [WinAppSDK.DesktopPopupSiteBridge?] = .from(abiBridge: __IMPL_Microsoft_UI_Content.DesktopPopupSiteBridgeBridge.self, abi: (count: $1, start: $2))
        let result = __unwrapped__instance.getMany(&items)
        items.fill(abi: $2, abiBridge: __IMPL_Microsoft_UI_Content.DesktopPopupSiteBridgeBridge.self)
        $3?.initialize(to: result)
        return S_OK
    }
)
...
public class IIteratorDesktopPopupSiteBridge: WindowsFoundation.IInspectable {
    ...
    open func get_Current() throws -> WinAppSDK.DesktopPopupSiteBridge? {
        let (result) = try ComPtrs.initialize { resultAbi in
    ...
    open func GetMany(_ items: inout [WinAppSDK.DesktopPopupSiteBridge?]) throws -> UInt32 {
        var result: UINT32 = 0
        try items.toABI(abiBridge: __IMPL_Microsoft_UI_Content.DesktopPopupSiteBridgeBridge.self) { _items in
            _ = try perform(as: __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CDesktopPopupSiteBridge.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.GetMany(pThis, _items.count, _items.start, &result))
            }
        items = .from(abiBridge: __IMPL_Microsoft_UI_Content.DesktopPopupSiteBridgeBridge.self, abi: _items)
        }
        return result
    }
...
fileprivate class __x_ABI_C__FIIterator_1___x_ABI_CMicrosoft__CUI__CContent__CDesktopPopupSiteBridgeImpl : IIterator, AbiInterfaceImpl {
    ...
    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.collections.iiterator-1.getmany)
    fileprivate func getMany(_ items: inout [WinAppSDK.DesktopPopupSiteBridge?]) -> UInt32 {
        try! _default.GetMany(&items)
    }
...
private var IID___x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIsland: WindowsFoundation.IID {
    .init(Data1: 0xc6a407be, Data2: 0x77d6, Data3: 0x5b90, Data4: ( 0x9b,0x56,0xff,0x65,0x4d,0x38,0x32,0xd8 ))// c6a407be-77d6-5b90-9b56-ff654d3832d8
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIsland {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandVTable: __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandVtbl = .init(
    QueryInterface: { __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandWrapper.addRef($0) },
    Release: { __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let sender: Any? = __ABI_.AnyWrapper.unwrapFrom(abi: ComPtr($1))
            let args: WinAppSDK.ContentIsland? = __IMPL_Microsoft_UI_Content.ContentIslandBridge.from(abi: ComPtr($2))
            try __unwrapped__instance(sender, args)
            return S_OK
        } catch { return failWith(error: error) }
    }
)
typealias __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandBridge>
public class EventHandlerContentIsland: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIsland }

    open func Invoke(_ sender: Any?, _ args: WinAppSDK.ContentIsland?) throws {
        let senderWrapper = __ABI_.AnyWrapper(sender)
        let _sender = try! senderWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIsland.self) { pThis in
...
internal class __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIslandBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.EventHandler<WinAppSDK.ContentIsland?>
    internal typealias CABI = __x_ABI_C__FIEventHandler_1___x_ABI_CMicrosoft__CUI__CContent__CContentIsland
    internal typealias SwiftABI = WinAppSDK.EventHandlerContentIsland
...
internal var __x_ABI_C__FIReference_1_GUIDVTable: __x_ABI_C__FIReference_1_GUIDVtbl = .init(
    ...
    GetIids: {
        ...
        iids[0] = IUnknown.IID
        iids[1] = IInspectable.IID
        iids[2] = WinAppSDK.__x_ABI_C__FIReference_1_GUIDWrapper.IID
        iids[3] = __ABI_Windows_Foundation.IPropertyValueWrapper.IID
        $1!.pointee = 4
        $2!.pointee = iids
        return S_OK
...
typealias __x_ABI_C__FIReference_1_GUIDWrapper = ReferenceWrapperBase<WinAppSDK.__x_ABI_C__FIReference_1_GUIDBridge>
...
private var IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectable: WindowsFoundation.IID {
    .init(Data1: 0x8ff86804, Data2: 0x5401, Data3: 0x5a46, Data4: ( 0xa1,0xe5,0x03,0x84,0xb7,0x5f,0x1b,0x3a ))// 8ff86804-5401-5a46-a1e5-0384b75f1b3a
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectable {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableVtbl = .init(
    QueryInterface: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableWrapper.addRef($0) },
    Release: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
...
typealias __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableBridge>
public class TypedEventHandlerContentIslandEnvironment_Any: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectable }

    open func Invoke(_ sender: WinAppSDK.ContentIslandEnvironment?, _ args: Any?) throws {
        let argsWrapper = __ABI_.AnyWrapper(args)
        let _args = try! argsWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectable.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, RawPointer(sender), _args))
        }
    }
...
internal class __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectableBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.TypedEventHandler<WinAppSDK.ContentIslandEnvironment?, Any?>
    internal typealias CABI = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CContentIslandEnvironment_IInspectable
    internal typealias SwiftABI = WinAppSDK.TypedEventHandlerContentIslandEnvironment_Any
...
internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteAutomation___x_ABI_CMicrosoft__CUI__CContent__CContentSiteAutomationProviderRequestedEventArgsVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteAutomation___x_ABI_CMicrosoft__CUI__CContent__CContentSiteAutomationProviderRequestedEventArgsVtbl = .init(
    ...
    Invoke: {
        do {
            ...
            let args: WinAppSDK.ContentSiteAutomationProviderRequestedEventArgs? = __IMPL_Microsoft_UI_Content.ContentSiteAutomationProviderRequestedEventArgsBridge.from(abi: ComPtr($2))
            try __unwrapped__instance(sender, args)
            return S_OK
        } catch { return failWith(error: error) }
    }
...
public class TypedEventHandlerIContentSiteAutomation_ContentSiteAutomationProviderRequestedEventArgs: WindowsFoundation.IUnknown {
    ...
    open func Invoke(_ sender: WinAppSDK.AnyIContentSiteAutomation?, _ args: WinAppSDK.ContentSiteAutomationProviderRequestedEventArgs?) throws {
...
private var IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgs: WindowsFoundation.IID {
    .init(Data1: 0x6c51df92, Data2: 0x39bb, Data3: 0x5287, Data4: ( 0xb8,0x5f,0x8f,0xd9,0x92,0x32,0xd0,0xca ))// 6c51df92-39bb-5287-b85f-8fd99232d0ca
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgs {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsVtbl = .init(
    QueryInterface: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsWrapper.addRef($0) },
    Release: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let sender: WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate? = __ABI_Microsoft_UI_Content.IContentSiteBridgeEndpointConnectionPrivateWrapper.unwrapFrom(abi: ComPtr($1))
            let args: WinAppSDK.EndpointConnectionEventArgs? = __IMPL_Microsoft_UI_Content.EndpointConnectionEventArgsBridge.from(abi: ComPtr($2))
            try __unwrapped__instance(sender, args)
            return S_OK
        } catch { return failWith(error: error) }
    }
)
typealias __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsBridge>
public class TypedEventHandlerIContentSiteBridgeEndpointConnectionPrivate_EndpointConnectionEventArgs: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgs }

    open func Invoke(_ sender: WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate?, _ args: WinAppSDK.EndpointConnectionEventArgs?) throws {
        let senderWrapper = __ABI_Microsoft_UI_Content.IContentSiteBridgeEndpointConnectionPrivateWrapper(sender)
        let _sender = try! senderWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgs.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, _sender, RawPointer(args)))
        }
    }
...
internal class __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgsBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.TypedEventHandler<WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate?, WinAppSDK.EndpointConnectionEventArgs?>
    internal typealias CABI = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointConnectionEventArgs
    internal typealias SwiftABI = WinAppSDK.TypedEventHandlerIContentSiteBridgeEndpointConnectionPrivate_EndpointConnectionEventArgs
...
private var IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgs: WindowsFoundation.IID {
    .init(Data1: 0x11337349, Data2: 0x3e22, Data3: 0x5200, Data4: ( 0xb8,0x78,0x87,0xc7,0x21,0xd3,0x14,0x45 ))// 11337349-3e22-5200-b878-87c721d31445
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgs {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsVtbl = .init(
    QueryInterface: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsWrapper.addRef($0) },
    Release: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let sender: WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate? = __ABI_Microsoft_UI_Content.IContentSiteBridgeEndpointConnectionPrivateWrapper.unwrapFrom(abi: ComPtr($1))
            let args: WinAppSDK.EndpointRequestedStateChangedEventArgs? = __IMPL_Microsoft_UI_Content.EndpointRequestedStateChangedEventArgsBridge.from(abi: ComPtr($2))
            try __unwrapped__instance(sender, args)
            return S_OK
        } catch { return failWith(error: error) }
    }
)
typealias __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsBridge>
public class TypedEventHandlerIContentSiteBridgeEndpointConnectionPrivate_EndpointRequestedStateChangedEventArgs: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgs }

    open func Invoke(_ sender: WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate?, _ args: WinAppSDK.EndpointRequestedStateChangedEventArgs?) throws {
        let senderWrapper = __ABI_Microsoft_UI_Content.IContentSiteBridgeEndpointConnectionPrivateWrapper(sender)
        let _sender = try! senderWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgs.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, _sender, RawPointer(args)))
        }
    }
...
internal class __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgsBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.TypedEventHandler<WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate?, WinAppSDK.EndpointRequestedStateChangedEventArgs?>
    internal typealias CABI = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CContent__CIContentSiteBridgeEndpointConnectionPrivate___x_ABI_CMicrosoft__CUI__CContent__CEndpointRequestedStateChangedEventArgs
    internal typealias SwiftABI = WinAppSDK.TypedEventHandlerIContentSiteBridgeEndpointConnectionPrivate_EndpointRequestedStateChangedEventArgs
...
private var IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgs: WindowsFoundation.IID {
    .init(Data1: 0xba7335ac, Data2: 0x108e, Data3: 0x530f, Data4: ( 0xa9,0x04,0x3b,0x59,0x17,0x5e,0x4a,0xb1 ))// ba7335ac-108e-530f-a904-3b59175e4ab1
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgs {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsVtbl = .init(
    QueryInterface: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsWrapper.addRef($0) },
    Release: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let sender: WinAppSDK.InputPointerSource? = __IMPL_Microsoft_UI_Input.InputPointerSourceBridge.from(abi: ComPtr($1))
            let args: WinAppSDK.TouchHitTestingEventArgs? = __IMPL_Microsoft_UI_Input.TouchHitTestingEventArgsBridge.from(abi: ComPtr($2))
            try __unwrapped__instance(sender, args)
            return S_OK
        } catch { return failWith(error: error) }
    }
)
typealias __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsBridge>
public class TypedEventHandlerInputPointerSource_TouchHitTestingEventArgs: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgs }

    open func Invoke(_ sender: WinAppSDK.InputPointerSource?, _ args: WinAppSDK.TouchHitTestingEventArgs?) throws {
        _ = try perform(as: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgs.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, RawPointer(sender), RawPointer(args)))
        }
    }
...
internal class __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgsBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.TypedEventHandler<WinAppSDK.InputPointerSource?, WinAppSDK.TouchHitTestingEventArgs?>
    internal typealias CABI = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CInput__CInputPointerSource___x_ABI_CMicrosoft__CUI__CInput__CTouchHitTestingEventArgs
    internal typealias SwiftABI = WinAppSDK.TypedEventHandlerInputPointerSource_TouchHitTestingEventArgs
...
public extension EventSource where Handler == TypedEventHandler<IContentSiteAutomation?, ContentSiteAutomationProviderRequestedEventArgs?> {
    func invoke(_ sender: WinAppSDK.AnyIContentSiteAutomation!, _ args: WinAppSDK.ContentSiteAutomationProviderRequestedEventArgs!) throws {
        for handler in getInvocationList() {
            try handler(sender, args)
        }
    }
...
public extension EventSource where Handler == TypedEventHandler<IContentSiteBridgeEndpointConnectionPrivate?, EndpointConnectionEventArgs?> {
    func invoke(_ sender: WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate!, _ args: WinAppSDK.EndpointConnectionEventArgs!) throws {
        for handler in getInvocationList() {
            try handler(sender, args)
        }
    }
...
public extension EventSource where Handler == TypedEventHandler<IContentSiteBridgeEndpointConnectionPrivate?, EndpointRequestedStateChangedEventArgs?> {
    func invoke(_ sender: WinAppSDK.AnyIContentSiteBridgeEndpointConnectionPrivate!, _ args: WinAppSDK.EndpointRequestedStateChangedEventArgs!) throws {
        for handler in getInvocationList() {
            try handler(sender, args)
        }
    }
