...
fileprivate func makeEnteredMoveSizeEventArgsFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return EnteredMoveSizeEventArgs(fromAbi: abi)
}

fileprivate func makeEnteringMoveSizeEventArgsFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return EnteringMoveSizeEventArgs(fromAbi: abi)
}

fileprivate func makeExitedMoveSizeEventArgsFrom(abi: WindowsFoundation.IInspectable) -> Any {
...
fileprivate func makeWindowRectChangedEventArgsFrom(abi: WindowsFoundation.IInspectable) -> Any {
    return WindowRectChangedEventArgs(fromAbi: abi)
}

fileprivate func makeWindowRectChangingEventArgsFrom(abi: WindowsFoundation.IInspectable) -> Any {
...
public class __MakeFromAbi: MakeFromAbi {
    public static func from(typeName: String, abi: WindowsFoundation.IInspectable) -> Any? {
        switch typeName {
            ...
            case "EnteredMoveSizeEventArgs": return makeEnteredMoveSizeEventArgsFrom(abi: abi)
            case "EnteringMoveSizeEventArgs": return makeEnteringMoveSizeEventArgsFrom(abi: abi)
            case "ExitedMoveSizeEventArgs": return makeExitedMoveSizeEventArgsFrom(abi: abi)
            ...
            case "WindowRectChangedEventArgs": return makeWindowRectChangedEventArgsFrom(abi: abi)
            case "WindowRectChangingEventArgs": return makeWindowRectChangingEventArgsFrom(abi: abi)
